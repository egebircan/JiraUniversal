const TASKS_BASE_URL = 'https://jirauniversal-backend.herokuapp.com/tasks'
const TOTAL_SCORE_BASE_URL = 'https://jirauniversal-backend.herokuapp.com/totalScore'
const AUTH_BASE_URL = 'https://jirauniversal-backend.herokuapp.com/auth'
